        ...
        <div className="columns small-12 landing-container">
          ...
          <div className="row align-center">
            <div className="columns small-8">
              <p className="landing-paragraph">The Calorie Calculator is Marc’s revolutionary tool that will help you reach your fitness goals through a personalized breakdown of your macronutrient and caloric needs.</p>
